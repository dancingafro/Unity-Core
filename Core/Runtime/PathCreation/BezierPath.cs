...
namespace CoreScript.PathCreation
{
    ...
    public class BezierPath
    {
        ...
        public Vector3 this[int i] { get { return GetPoint(i); } }
        ...
        public int NumAnchorPoints { get { return (IsClosed) ? points.Count / 3 : (points.Count + 2) / 3; } }
        ...
        public void SplitSegment(Vector3 anchorPos, int segmentIndex, float splitTime)
        {
            ...
            else
            {
                ...
                Vector3[][] splitSegment = PathUtility.SplitCurve(GetPointsInSegment(segmentIndex), splitTime);
                ...
                {
                    float avgDst = ((splitSegment[0][2] - anchorPos).magnitude + (splitSegment[1][1] - anchorPos).magnitude) * .5f;
        ...
        public void DeleteSegment(int anchorIndex)
        {
            ...
            if ((isClosed && NumSegments <= 1) || NumSegments <= 2)
                return;
            ...
            if (anchorIndex == 0)
            {
                ...
                points.RemoveRange(anchorIndex - (anchorIndex == points.Count - 1 && !isClosed ? 2 : 1), 3);
        ...
        void AutoSetStartAndEndControls()
        {
            if (isClosed)
            {
                ...
                points[1] = points[0] + perp * dstBetweenAnchors * .5f;
                points[5] = points[0] - perp * dstBetweenAnchors * .5f;
                points[2] = points[3] + perp * dstBetweenAnchors * .5f;
                points[4] = points[3] - perp * dstBetweenAnchors * .5f;
                return;
            }
