...
namespace CoreScript.PathCreation
{
    ...
    public class VertexPath
    {
        ...
        public Vector3 GetTangent(int index) { return MathUtility.TransformDirection(localTangents[index], transform, space); }
        public Vector3 GetNormal(int index) { return MathUtility.TransformDirection(localNormals[index], transform, space); }
        public Vector3 GetPoint(int index) { return MathUtility.TransformPoint(localPoints[index], transform, space); }
        ...
        public struct TimeOnPathData
        {
            ...
            public TimeOnPathData(int previousIndex, int nextIndex, float percentBetweenIndices)
            {
